          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h1 className="text-3xl font-bold">Personal Archive</h1>
                  <p className="text-gray-400">Your saved messages</p>
                </div>
              </div>
            </div>
            <Link href="/personal">
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="text-center p-4 bg-gray-700/30 rounded-lg">
                  ...
                  <div className="text-sm text-gray-400">Saved Messages</div>
                </div>
                <div className="text-center p-4 bg-gray-700/30 rounded-lg">
          ...
          {error && (
            <Card className="bg-red-900/20 border-red-700">
              <CardContent className="p-6 text-center">
                <p className="text-red-400 mb-4">Failed to load your archived messages</p>
                <Button 
          ...
          {!isLoading && !error && (!likedMessages || likedMessages.length === 0) && (
            <Card className="bg-gray-800/50 border-gray-700">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-xl font-semibold text-white mb-2">No saved messages yet</h3>
